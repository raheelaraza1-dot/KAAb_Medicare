      ...
      <PageTransition>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-2">
          <section className="rounded-2xl border border-gray-200 bg-white p-5">
            ...
            <p className="mt-1 font-medium">{email || 'Admin'}</p>
            ...
            <button
              ...
              className="mt-5 rounded-xl border border-gray-200 px-4 py-2 text-sm font-medium hover:bg-gray-50"
            >
              Sign out
            </button>
          </section>
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-5">
            ...
            <p className="mt-1 break-all font-medium">{API_URL}</p>
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-5 lg:col-span-2">
            <h3 className="font-semibold">Clinic workspace</h3>
